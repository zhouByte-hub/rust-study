...
mod handlebars_test{
    ...
    fn string_template_test(){
        ...
        handlebars.register_template_string("show_user", "{{username}} is {{age}} years old.").unwrap();
    ...
    fn file_template_test(){
        ...
        let mut handlebars = Handlebars::new();
        handlebars.register_template_file("show_user", "src/web/template/user.html").unwrap();
