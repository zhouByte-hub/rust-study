...
pub fn live_cycle_test_3(_value1: &str) -> &str {
    //符合条件2
    _value1
}
...
impl A {
    ...
    pub fn live_cycle_test_5<'a>(&self, value1: &'a str, _value2: &'a str) -> &'a str {
        // 符合条件4
        value1
    }
}
...
#[cfg(test)]
mod test_live_cycle {
    use crate::chapter_5::live_cycle::{User, live_cycle_test_1};
